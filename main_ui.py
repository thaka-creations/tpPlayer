...
from new_player import VideoWidget
...
"padding:0px;")
        ...
        self.frame.setStyleSheet("border: 1px solid #5968B0;\n")
...
#         self.settingsButton.setObjectName("settingsButton")
        ...
        self.videoWidget = VideoWidget(self.stackedWidget)
        self.videoWidget.setObjectName("page_2")
...
"color: white;")
        ...
        self.frame_3.setStyleSheet("border: 1px solid #5968B0;\n")
...
"color: white;")
        ...
        self.keyListWidget.setStyleSheet("color: black; border: 1px solid #5968B0;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        try:
            logo = os.path.join(sys._MEIPASS, "assets/logo.png")
        except AttributeError:
            logo = os.path.join("assets/logo.png")
        self.pixmap = QtGui.QPixmap(logo)
        self.pixmap = self.pixmap.scaled(350, 350, QtCore.Qt.AspectRatioMode.KeepAspectRatio,
